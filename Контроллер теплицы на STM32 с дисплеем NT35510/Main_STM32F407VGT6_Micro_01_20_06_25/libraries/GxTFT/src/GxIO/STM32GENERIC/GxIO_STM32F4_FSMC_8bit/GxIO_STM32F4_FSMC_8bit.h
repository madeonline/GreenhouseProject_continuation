...
#ifndef _GxIO_STM32GENERIC_STM32F4_FSMC_8BIT_H_
#define _GxIO_STM32GENERIC_STM32F4_FSMC_8BIT_H_

#include "../../GxIO.h"

#if defined(ARDUINO_ARCH_STM32) && (defined(STM32F407VE) || defined(STM32F407ZE) || defined(STM32F407ZG) || defined(STM32F407VG))

class GxIO_STM32F4_FSMC_8Bit : public GxIO
{
  public:
    GxIO_STM32F4_FSMC_8Bit();
    const char* name = "GxIO_STM32F4_FSMC_8bit";
    void reset();
    void init();
  ...
  private:
    int8_t _cs, _rs, _rst, _wr, _rd; // Control lines
};

#define GxIO_Class GxIO_STM32F4_FSMC_8Bit
