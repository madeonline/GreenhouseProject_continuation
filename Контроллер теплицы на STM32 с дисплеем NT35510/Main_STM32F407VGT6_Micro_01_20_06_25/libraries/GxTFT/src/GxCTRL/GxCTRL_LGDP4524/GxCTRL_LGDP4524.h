...
class GxCTRL_LGDP4524 : public GxCTRL
{
  public:
    GxCTRL_LGDP4524(GxIO& io) : GxCTRL(io), physical_width(176), physical_height(220) {};
    GxCTRL_LGDP4524(GxIO& io, uint16_t phy_w, uint16_t phy_h) : GxCTRL(io), physical_width(phy_w), physical_height(phy_w) {};
    const char* name = "GxCTRL_LGDP4524";
    const uint32_t ID = 0x4524;
    uint32_t readID();
...
#define GxCTRL_Class GxCTRL_LGDP4524
