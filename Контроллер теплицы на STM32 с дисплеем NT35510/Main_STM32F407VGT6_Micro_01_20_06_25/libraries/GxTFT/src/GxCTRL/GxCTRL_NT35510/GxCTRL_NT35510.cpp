...
//
// this class works with "IPS 3.97 inch 16.7M HD TFT LCD Touch Screen Module NT35510 Drive IC 480(RGB)*800" display from Ruijia Industry
// e.g. https://www.aliexpress.com/item/IPS-3-97-inch-HD-TFT-LCD-Touch-Screen-Module-NT35510-Drive-IC-800-480/32676929794.html
...
//
// note: this display needs 16bit commands, aka "(MDDI/SPI) Address" in some NT35510.pdf
...
#define NT35510_MADCTL_BGR 0x08
...
#if defined(NT35510_RAMRD_AUTO_INCREMENT_OK) // not ok on my display
...
{
  IO.startTransaction();
  IO.writeCommand16(NT35510_MADCTL);
  switch (r & 3)
  {
    case 0:
      IO.writeData(0);
      break;
    case 1:
      IO.writeData(NT35510_MADCTL_MX | NT35510_MADCTL_MV);
      break;
    case 2:
      IO.writeData(NT35510_MADCTL_MX | NT35510_MADCTL_MY);
      break;
    case 3:
      IO.writeData(NT35510_MADCTL_MY | NT35510_MADCTL_MV);
      break;
  }
  IO.endTransaction();
}
