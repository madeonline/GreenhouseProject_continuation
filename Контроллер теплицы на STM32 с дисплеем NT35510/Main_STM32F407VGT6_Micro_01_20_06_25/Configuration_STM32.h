...
#define WM_RAIN_BGCOLOR 0x0400
#define WM_RAIN_FONT_COLOR WHITE
...
#define WM_BLINK_ON_TEXT_COLOR WHITE
#define WM_BLINK_OFF_TEXT_COLOR 0x3A8D
#define WM_ON_BLINK_BGCOLOR MAROON
#define WM_OFF_BLINK_BGCOLOR LGRAY

#define WM_SECTION_1_BGCOLOR YELLOW
#define WM_SECTION_1_FONT_COLOR BLACK

#define WM_SECTION_2_BGCOLOR GREEN
#define WM_SECTION_2_FONT_COLOR WHITE

#define WM_SECTION_3_BGCOLOR BLUE
#define WM_SECTION_3_FONT_COLOR WHITE

#define WM_SECTION_4_BGCOLOR MAROON
#define WM_SECTION_4_FONT_COLOR WHITE
...
// экраны
//--------------------------------------------------------------------------------------------------------------------------------
#define USE_TFT_MODULE // закомментировать, если не нужна поддержка TFT с разрешением 800x480
...
#define VIRTUAL_PIN_START_NUMBER 110 // номер пина, с которого все пины будут считаться виртуальными, т.е. запись в них производиться не будет, однако в карте пинов (16 байт) этот статус будет отражён.
...
// цвета для TFT
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define TFT_BACK_COLOR WHITE // цвет фона
#define TFT_BUTTON_COLORS WHITE, 0x8410, WHITE, 0xF800, 0x001F
...
#define INFO_BOX_BORDER_COLOR BLACK // цвет рамки информационного бокса
#define INFO_BOX_CAPTION_COLOR 0x33D6 // цвет заголовка информационного бокса
#define SENSOR_BOX_FONT_COLOR WHITE // цвет показаний датчика
#define SENSOR_BOX_UNIT_COLOR WHITE // цвет единиц изменений датчика
#define MODE_ON_COLOR 0x0400   // цвет "вкл", "авто"
#define MODE_OFF_COLOR 0x8000 // цвет "выкл", "ручной"
#define CHANNELS_BUTTONS_TEXT_COLOR WHITE // цвет текста кнопок каналов
...
#define TIME_PART_SELECTED_FONT_COLOR WHITE // цвет текста активной кнопки компонента времени
...
#define TFT_WATERING_SETT_HUM_BORDER "ПОРОГ ВЛАЖНОСТИ:"
