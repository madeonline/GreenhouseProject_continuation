...
/* function calls is not working, as it will have too much overhead */
  ...
  #define START_PULSE_TIME_OUT  (1255)  //! This value is decremented while waiting for the falling edge of a start pulse.
  #define ZERO_PULSE_TIME_OUT   (126) //! This value is decremented while waiting for the falling edge of a zero pulse.
#else
...
#define BIT_DELAY	      		(4)		//! delay macro for width of one pulse (start pulse or zero pulse, in microseconds)
...
public:
	 ...
	 */
	explicit atsha204Class(uint8_t pin, bool withDisableInterrupts);
