...
//-----------------------------------------------------------------------------------------------------
DeltaTypes = {'TEMP' : 'Температура', 'HUMIDITY' : 'Влажность', 'LIGHT' : 'Освещенность', 'SOIL' : 'Влажность почвы', 'PH' : 'Значение pH'}
var MAX_DELTAS = 20; // максимальное кол-во дельт в контроллере
//-----------------------------------------------------------------------------------------------------
