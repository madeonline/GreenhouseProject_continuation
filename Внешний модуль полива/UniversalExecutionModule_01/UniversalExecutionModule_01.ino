...
#ifdef _DEBUG 
	// Мой тест
	Serial.print(packetSize); Serial.print(" controller ID - ");
	Serial.print(nrfPacket.controller_id); Serial.print(" scratchpadS ID - ");
	Serial.print(scratchpadS.controller_id); Serial.print(" packetRssi - ");
