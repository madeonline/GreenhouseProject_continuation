...
#define LORA_POWER         A3         // управление питанием модуля LoRa
...
const SensorSettings Sensors[3] = {
	...
	{mstDHT22,A1, 0}     // датчик DHT2x на пине A1
/* 
...
void initLoRa()
{
  ...
  pinMode(LORA_POWER, OUTPUT);                // настроить pin управления питанием модуля LORA
  digitalWrite(LORA_POWER, LOW);              // включить питание модуля LORA
  // инициализируем LoRa
