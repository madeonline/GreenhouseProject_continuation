...
void Touch_Calibrate ( void )
{
	...
	TFT_Draw_Line ( 10, 10+25, 10+50, 10+25, 0x0000,1 );
	TFT_Draw_Line ( 10+25, 10, 10+25, 10+50, 0x0000,1 );
	...
	TFT_Clear_Screen (WHITE);
	TFT_Draw_String( 50, 100, 0xFFE0, 0x0000, *font8x8, "Callibration", 3 );
	TFT_Draw_Line  ( TFT_PIXEL_WIDTH -10-50, 10+25, TFT_PIXEL_WIDTH -10-50+50, 10+25, 0x0000,1 );
	TFT_Draw_Line  ( TFT_PIXEL_WIDTH -10-25, 10, TFT_PIXEL_WIDTH -10-25, 10+50, 0x0000,1 );
	...
	TFT_Clear_Screen (WHITE);
	TFT_Draw_String( 50, 100, 0xFFE0, 0x0000, *font8x8, "Callibration", 3 );
	TFT_Draw_Line  ( 10, TFT_PIXEL_HEIGHT-10-25, 10+50, TFT_PIXEL_HEIGHT-10-25, 0x0000,1 );	// hor
	TFT_Draw_Line  ( 10+25, TFT_PIXEL_HEIGHT-10-50, 10+25, TFT_PIXEL_HEIGHT-10-50+50, 0x0000,1 );	// vert
	...
	TFT_Clear_Screen (WHITE);
	TFT_Draw_String( 50, 100, 0xFFE0, 0x0000, *font8x8, "Callibration",  3 );
	TFT_Draw_Line  ( TFT_PIXEL_WIDTH -10-50, TFT_PIXEL_HEIGHT-10-25, TFT_PIXEL_WIDTH -10-50+50, TFT_PIXEL_HEIGHT-10-25, 0x0000,1 );	// hor
	TFT_Draw_Line  ( TFT_PIXEL_WIDTH -10-25, TFT_PIXEL_HEIGHT-10-50, TFT_PIXEL_WIDTH -10-25, TFT_PIXEL_HEIGHT-10-50+50, 0x0000,1 );	// vert
...
int main(void)
{
	...
	TFT_Draw_String(400, 300, BLUE, BLACK,(const uint8_t*) font8x8, "hubstub",5);
	TFT_Draw_Rectangle(600,300,100,100,4,BLACK);
	TFT_Draw_Line(120,120, 280,280,BLACK,3);
	TFT_Draw_Triangle(100,100,100,200,300,300,2,DARK_BLUE);
	TFT_Draw_Circle(400,400,50,0,2,YELLOW);
	TFT_Draw_Circle(400,400,50,1,2,YELLOW);
	//TFT_Draw_Circle(200,200,100,1,2,YELLOW);
	...
	TFT_Draw_String(170, 65, BLUE, WHITE,(const uint8_t*) font8x8, "Start",3);*/
	...
	while(1)
	{
		if(isTouch())
		{
			...
			TFT_Draw_Fill_Rectangle(touch_kor_x,touch_kor_y,2,2,BLACK);
