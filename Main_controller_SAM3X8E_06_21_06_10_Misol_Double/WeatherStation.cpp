...
void WeatherStationClass::update()
{
	...
	if (flag == 1) //если были данные
	{
		...
		//flag = false;                           // Данные получены и зарегистрированы
		I2C2.writeByte(0x01, 14, flag);         //Данные получены и зарегистрированы. Отправляем состояние флага ведомому (адрес ведомого 0x01, номер регистра 9, состояние флага)
  	}
}
