...
//--------------------------------------------------------------------------------------------------------------------------------
//#define WATER_TANK_MODULE_DEBUG // отладочный режим модуля контроля уровня воды, закомментировать, если в нём нет необходимости (НЕ РАБОТАЕТ СОВМЕСТНО С КОНФИГУРАТОРОМ, ПЛЮЁТСЯ в Serial!)
//--------------------------------------------------------------------------------------------------------------------------------
