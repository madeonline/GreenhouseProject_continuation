...
bool Adafruit_Si7021::begin(void) {
 ...
 // SerialUSB.println(sernum_a, HEX);
 // SerialUSB.println(sernum_b, HEX);
...
void Adafruit_Si7021::writeRegister8(uint8_t reg, uint8_t value) {
 ...
 // SerialUSB.print("Wrote $"); SerialUSB.print(reg, HEX); SerialUSB.print(": 0x"); SerialUSB.println(value, HEX);
}
...
uint8_t Adafruit_Si7021::readRegister8(uint8_t reg) {
  ...
  //SerialUSB.print("Read $"); SerialUSB.print(reg, HEX); SerialUSB.print(": 0x"); SerialUSB.println(value, HEX);
  return value;
}
