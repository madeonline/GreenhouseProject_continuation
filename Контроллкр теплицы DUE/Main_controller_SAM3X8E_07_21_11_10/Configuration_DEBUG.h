...
//--------------------------------------------------------------------------------------------------------------------------------
//#define WATER_TANK_MODULE_DEBUG // отладочный режим модуля контроля уровня воды, закомментировать, если в нём нет необходимости (ПЛЮЁТСЯ в SerialUSB!)
//--------------------------------------------------------------------------------------------------------------------------------
// отладочный режим модуля метеостанции Misol
//#define MISOL_DEBUG
//--------------------------------------------------------------------------------------------------------------------------------
// отладочный режим датчиков влажности почвы
//#define SOIL_MOISTURE_MODULE_DEBUG
//--------------------------------------------------------------------------------------------------------------------------------
// отладочный режим эмулятора 1 Ware
//#define ONE_WIRE_EMULATION_MODULE_DEBUG
//--------------------------------------------------------------------------------------------------------------------------------
