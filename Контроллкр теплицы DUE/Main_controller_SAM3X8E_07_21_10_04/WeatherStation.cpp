	...
	if (flag == 1) //если были данные
	{
		...
		while (var < 5)       // Пять попыток получить информацию с приемника Misol
		{
			...
			if (crc == calc_REG_Array())                       // Если данные верны - завершить попытки чтения данных
			{
					...
					SerialUSB.print("crc1 - ");
					SerialUSB.println(crc);
					SerialUSB.print("calc_REG_Array - ");
					SerialUSB.println(calc_REG_Array());
					SerialUSB.print("Misol WS0232 ID -");
					SerialUSB.println(_ID_Misol_WS0232, HEX);
		...
		{ //первый байт должен быть 0xF5 (ID станции, может варьироваться от модели и верный CRC
			...
			if (rain != 0xFF) // если данные по дождю валидны
			{
				...
				switch (wind_dirI2C)
				{
				case 0: SerialUSB.print("N"); break;
				case 2: SerialUSB.print("NE"); break;
				case 4: SerialUSB.print("E"); break;
				case 6: SerialUSB.print("SE"); break;
				case 8: SerialUSB.print("S"); break;
				case 10: SerialUSB.print("SW"); break;
				case 12: SerialUSB.print("W"); break;
				case 14: SerialUSB.print("NW"); break;
				default: SerialUSB.print("Error"); break;
				}

				SerialUSB.print("\n");

				SerialUSB.print("Rain pulse: ");  // счетчик дождя
